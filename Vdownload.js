...
// @version      0.3
// @description  得到的音视频可用我的软件进行批量合并音视频···
// @author       浣熊
// @match        *://*/*
...
(function() {
    ...
    $(function () {
        if (document.querySelector('video') === null && 1 === 1)
            return;
        ...
        $('body').prepend(`
            <div class="aside-nav bounceInUp animated no-filter" id="VdownLoad-nav">
                ...
                <a href="javascript:void(0)" title="本次关闭" onclick="$('#VdownLoad-nav').slideUp()"
