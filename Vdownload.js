...
(function () {
    ...
    const SetplaybackRate = (e) => {
        ...
        const XFrun = () => {
            ...
            $('body').prepend(`
            <div class="aside-nav bounceInUp animated no-filter" id="VdownLoad-nav">
                <label for="" class="aside-menu" title="按住拖动">Videos</label>
                <a href="javascript:void(0)" title="本次关闭" id="XFclose"
                    class="menu-item menu-line menu-first">本次<br>关闭</a>
                <a href="javascript:void(0)" id="vdown0" title="缓存进度条完成时，自动下载视频"
                    class="menu-item menu-line menu-second">下载<br>视频</a>
                <a href="javascript:void(0)" id="vdown1" title="缓存进度条完成时，自动下载视频,并自动关闭当前页"
                    class="menu-item menu-line menu-third">下载后<br>关闭</a>
                <a href="javascript:void(0)" title="设置播放速度" id="SetplaybackRate"
                    class="menu-item menu-line menu-fourth">设置<br>速度</a>
            </div>
            `)
        ...
        const Msg = (id,msgtxt) => {
            $('body').append('<div id="'+id+'" class="MsgQB">'+msgtxt+'  ヾ(•ω•`)o</div>');
            let randomColor = Math.floor(Math.random() * 16777215).toString(16);
            let $el = $('#'+id);
            $el.css('background', ColorReverse(randomColor)).css('color', ColorReverse(ColorReverse(randomColor)));
        ...
        function download() {
            ...
            a.click();
            Msg(guid(),downloadName+'  ,下载成功啦');
            setTimeout(()=>{Msg(guid(),downloadName+'  ,下载成功啦')},1000)
            window.downloadAll = 0;
            window.isComplete = 0;
            window.autoDownload = 0;
            if (isDelTabPage === 1) {
